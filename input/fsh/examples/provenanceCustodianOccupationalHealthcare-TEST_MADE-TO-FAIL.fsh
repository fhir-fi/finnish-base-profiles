Instance: ProvenanceCustodianOccupationalHealthcareTEST
...
Usage: #example
* id = "custodian-occupational-healthcare-TEST"
* target = Reference(EpisodeOfCare/id-for-episode-1)
* recorded = "2015-02-07T13:28:17.239+02:00"
* agent[custodian]
  * type
//    * coding[0] = http://terminology.hl7.org/CodeSystem/v3-ParticipationType#CSL "custodian"
...
//  * role = #sauce
  ...
  * what
    * identifier
//      * system = #urn:oid:1.2.246.537.6.40172
...
* entity[registerSpecifier]
  ...
  * what
    * identifier
//      * type = http://terminology.hl7.org/CodeSystem/v2-0203#TAXI
//      * system = "https://ytj.foo/"
